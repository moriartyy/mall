...
import static mall.service.common.config.ExceptionUtils.buildMessage;
...
public class ApiExceptionHandler {
    ...
    public Object handle(BindException e) {
        return ApiResult.fail(ApiStatus.INVALID_PARAMETER, buildMessage(e));
    }
    ...
    public Object handle(Exception e) {
        ...
        return ApiResult.fail(ApiStatus.INTERNAL_ERROR, e.getMessage());
    }
}
